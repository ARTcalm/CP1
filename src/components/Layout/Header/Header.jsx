        ...
        <>
            <div className={style.headerContainer} >
                <div className={style.menu}>
                    ...
                    <NavLink to={""} className={style.logo} ><img alt="logo" src="/img/Logo2.svg" style={{cursor:"pointer"}} /></NavLink>
                    <div className={style.nav}>
                ...
                <div className={style.mobileMenu}>
                    <NavLink to={""} className={style.logo} ><img alt="logo" src="/img/Logo2.svg" style={{cursor:"pointer"}} /></NavLink>
                    <img src={'/img/burger_menu.svg'}  style={{cursor:"pointer"}} onClick={() => setBurgerMenu(burgerMenu = !burgerMenu)}/>
                </div>
                {burgerMenu && (
