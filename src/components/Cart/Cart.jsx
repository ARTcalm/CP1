...
export const Cart = (props) => {
    const {cartItems, setCartItems, handleFavours} = props
        ...
        <div className={style.cart_container}>
                            ...
                            <div className={style.cart_card}>
                                ...
                                <div>
                                    ...
                                    <div className={style.features_card}>
                                        ...
                                        <div onClick={() => DeleteCartItems(el.id)}><svg width="35" height="35" viewBox="0 0 16 16"><path fill="white" d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5M8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5m3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0"></path></svg></div>
                                    </div>
                                </div>
                ...
                <div className={style.cartResult}>
                    <div>
                        ...
                        <p style={{fontSize:"24px", display:"flex", justifyContent:"space-between"}}>Итого: <span>{summa}₽</span></p>
                    </div>
                    <div>
                        <NavLink to={"delivery-form"}>Заказать</NavLink>
                    </div>
                </div>
        </div>
    )
